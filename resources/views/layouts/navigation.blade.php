                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('clinic-resources.index')">
                                    {{ __('Recursos Físicos') }}
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4 mb-2">
                    <div class="font-medium text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest">Configuración</div>
                </div>
                ...
                <div class="mt-2 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('clinics.edit', auth()->user()->clinic_id ?? 0)" :active="request()->routeIs('clinics.edit')">
                        {{ __('Datos de la Clínica') }}
                    </x-responsive-nav-link>
                </div>
            </div>
